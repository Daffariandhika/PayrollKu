        ...
        <div className="card">
          ...
          <div className="slip-main-container">
            ...
            <table className="slip-employee-table">
              <tbody>
                {[
                  ['Nama', payroll.name, 'Departemen', payroll.department],
                  ['ID', payroll.tag, 'Posisi', payroll.designation],
                  ['NPWP', formatField(payroll.npwp), 'Jabatan', formatField(payroll.level)],
                  ['Status', formatField(payroll.status), 'Periode', `${payroll.presentMonth} ${payroll.presentYear}`]
                ].map((row, idx) => (
                  <tr key={idx}>
                    <td>{row[0]}</td>
                    <td>:</td>
            ...
            <div className='totals-salary'>
              ...
              <div className='total-deductions'>
                Total Potongan: {formatMoney(payroll.totalDeductions)}
              </div>
            </div>
            ...
            <div className='bank-info'>
              Pembayaran telah dilakukan ke rekening {formatField(payroll.bankName)} {formatField(payroll.accountNumber)}
            </div>
