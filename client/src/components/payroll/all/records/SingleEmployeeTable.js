                    ...
                    <tbody>
                      {payrollRecords.map(payslip => (
                        <tr key={payslip._id} id="search-item">
                          ...
                          <td>{formatMoney(payslip.consolidationRelief)}</td>
                          <td>{formatMoney(payslip.pension)}</td>
                          <td>{formatMoney(payslip.taxableIncome)}</td>
                      ...
                      <tr>
                        ...
                        <td><strong>{formatMoney(cRSum)}</strong></td>
                        <td><strong>{formatMoney(pensionSum)}</strong></td>
                        <td><strong>{formatMoney(taxableIncomeSum)}</strong></td>
                        <td><strong>{formatMoney(taxPayableSum)}</strong></td>
                        <td><strong>{formatMoney(monthlyNetPaySum)}</strong></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
