                ...
                <tbody>
                    {payrolls.payslip.map(payrollItem => (
                        <tr key={payrollItem._id} id="search-item">
                            ...
                            <td>{formatMoney(payrollItem.consolidationRelief.toFixed(2))}</td>
                            <td>{formatMoney(payrollItem.pension.toFixed(2))}</td>
                            <td>{formatMoney(payrollItem.taxableIncome.toFixed(2))}</td>
                    ...
                    <tr>
                        ...
                        <td><strong>{formatMoney(payrolls.consolidationReliefSum.toFixed(2))}</strong></td>
                        <td><strong>{formatMoney(payrolls.pensionSum.toFixed(2))}</strong></td>
                        <td><strong>{formatMoney(payrolls.taxableIncomeSum.toFixed(2))}</strong></td>
